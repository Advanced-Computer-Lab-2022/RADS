      ...
      return (
        <Box>
          ...
          <Button
            variant="contained"
            onClick={() =>
              (window.location.href = `/corptraineecourse?courseId=${courseId}&corpTraineeId=${corpTraineeId}`)
            }
          >
            Go to course
          </Button>
        ...
        <Box>
          {
            <Button
              variant="contained"
              onClick={() =>
                (window.location.href = `/corptraineesubmitaccess?courseId=${courseId}&corpTraineeId=${corpTraineeId}`)
              }
              key={courseId}
            >
              Request Access for <strong>{course.courseTitle}</strong>
            </Button>
          }
        </Box>
      );
