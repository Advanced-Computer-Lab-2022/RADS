...
const CorpTraineeCourse = (props) => {
  ...
  const createCertificate = async (firstName, lastName, courseTitle) => {
    ...
    axios
      .post("/corptrainee/createpdf", body)
      .then((res) => {
  ...
  return (
    <Box>
      ...
      <Button
        variant="contained"
        onClick={() =>
          (window.location.href = `/corptraineerating?corpTraineeId=${corpTraineeId}&courseId=${courseId}`)
        }
      >
        Rate Course
      </Button>
      <Button
        variant="contained"
        onClick={() =>
          (window.location.href = `/corptraineesolve?corpTraineeId=${corpTraineeId}&courseId=${courseId}`)
        }
      >
        Solve Exercises
      </Button>
      <Button
        variant="contained"
        onClick={() =>
          (window.location.href = `/corptraineexam?corpTraineeId=${corpTraineeId}&courseId=${courseId}`)
        }
      >
        Solve Final Exam
      </Button>
