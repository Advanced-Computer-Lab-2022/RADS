  ...
  return (
    <Box>
      <Box>
        <p>
          <strong>
            Reviews & Ratings of instructor: {instructor.firstName}{" "}
            {instructor.lastName}
          </strong>
        </p>
        ...
        {reviews &&
          reviews.map((review, index) => (
            <Box>
              <p>
                Review {index + 1}: Rating: {review.iRating} out of 5.
              </p>
              <p>{review.iReview}</p>
      ...
      <Box>
        <p>
          <strong>Reviews & Ratings of instructor courses</strong>
        </p>
        {courses &&
          courses.map((course, index) => (
            <Box key={course._id}>
              <h4>
                Course {index + 1}:<strong> {course.courseTitle} </strong>
              </h4>
              ...
              {course.reviews &&
                course.reviews.map((review, index) => (
                  <Box>
                    <p>
                      Rating {index + 1}: {review.cRating} out of 5.
                    </p>
                    <p>
                      Review {index + 1}: {review.cReview}
                    </p>
                  </Box>
                ))}
              <p>
